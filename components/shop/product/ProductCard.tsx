...
export default function ProductCard({ product, catalogBadge = null }: ProductCardProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className={`group relative w-full overflow-hidden rounded-2xl border border-transparent bg-gradient-to-b from-white via-white to-zinc-50/90 p-[1px] shadow-[0_0px_0px_-0px_rgba(15,23,42,0.12),0_0_0_1px_rgba(255,255,255,0.06)_inset] transition-[box-shadow,border-color,transform] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            isHovered
              ? 'z-30 -translate-y-1 border-gray-200 shadow-lg'
              : 'z-0 translate-y-0'
          }`}
        >
